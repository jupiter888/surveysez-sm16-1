...
INDEX AnswerID_index(AnswerID),
FOREIGN KEY (SurveyID) REFERENCES srv_surveys(SurveyID) ON DELETE CASCADE
--FOREIGN KEY (QuestionID) REFERENCES srv_questions(QuestionID) ON DELETE CASCADE
)ENGINE=INNODB;


INSERT INTO srv_answers VALUES (NULL,1,'Yes, I highly admire the site!','This is my  favorite site',NOW(),NOW());
INSERT INTO srv_answers VALUES (NULL,1,'I absolutely love cookies','Cookies are my favorite',NOW(),NOW());
INSERT INTO srv_answers VALUES (NULL,1,'Favorite topping is fresh fruit and cream','Fresh fruit and cream are my favorite',NOW(),NOW());
